  ...
  return (
    ...
    >
      <div className="xl:w-[70%] md:w-[100%] w-[85%] h-auto relative c_lg:translate-x-0 translate-x-[15px]">
        <ul className="list-none after:absolute after:content-[' '] after:w-[2px]  after:h-full after:bg-[linear-gradient(to_bottom,_#bc11f5,_#a80eeb)] c_lg:after:left-auto after:left-[-30px] z-0">
          {data.map((e, i) => (
            <CardTimeline
              key={i}
              number={e.number}
