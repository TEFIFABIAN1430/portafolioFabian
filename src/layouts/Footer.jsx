...
const Footer = () => {
  ...
  return (
    <footer
      className={`w-full bg-[#08d4fc] border-y-2 border-y-[#C00B62] pt-16 pb-20 px-16 ${fonts.font_lilita}`}
    >
      <div className="grid c_lg:grid-cols-2 grid-cols-1 max-w-[85%] m-auto h-auto">
        ...
        >
          <ul className="text-[#1121fa] text-xl my-auto c_lg:mx-[10%] c_lg:mb-0 pb-3">
            <li className="pb-3">
        ...
        <div data-aos="zoom-in-left">
          <div className="text-[#b605f7] text-xl c_lg:block hidden">
            Tabla de Contenido de semanas de clase
          </div>
          <div className="grid md:grid-cols-2 grid-cols-2 text-white text-base p-2">
            {renderLinkGroups()}
          </div>
        </div>
      </div>
      ...
      >
        <Link
          href={"https://www.facebook.com/estefany.fabiansinti.9"}
          target="_blank"
        ...
        <Link
          href={"https://twitter.com/SadithSinti"}
          target="_blank"
          className="w-[50px] h-[50px] hover:w-[40px] hover:h-[40px] duration-500 my-auto"
        >
          <Image src={twitter} alt="twitter" />
        </Link>
        <Link
          href={"https://github.com/TEFIFABIAN1430"}
          target="_blank"
          className="w-[30px] h-[30px] hover:w-[40px] hover:h-[40px] duration-500 my-auto"
        >
      ...
      <div className="text-white text-center text-lg" data-aos="zoom-in-up">
        ...
        <p className="mb-2">Diseñado por Tefi Safi</p>
        <UserTitle />
      </div>
    </footer>
  );
