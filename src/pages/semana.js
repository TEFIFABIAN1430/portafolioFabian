...
export default function Semana() {
  ...
  return (
    <>
      ...
      <article
        className="min-h-screen bg-[#3217e6] z-20 pt-36 pb-10 sm:px-28 px-8 max-w-screen text-white"
        id="inits"
      >
        {dataGet ? (
          <div className="mx-auto p-4 sm:px-6 mt-5 h-full">
            ...
            <section className="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-28 items-center">
              <div className="relative block group" data-aos="zoom-in-right">
                <div
                  className="absolute inset-0 bg-[#7a0cf0] hidden md:block transform md:translate-y-2 md:translate-x-4 xl:translate-y-4 xl:translate-x-8 group-hover:translate-x-0 group-hover:translate-y-0 transition duration-700 ease-out pointer-events-none"
                  aria-hidden="true"
                ></div>
              ...
              <div data-aos="zoom-in-left">
                <header>
                  ...
                  <h3
                    className={`md:text-[30px] text-[23px] text-[#0ccee8] font-bold mb-2 mt-8  ${fonts.font_lilita}`}
                  >
                    {dataGet.theme}
                  </h3>
                </header>
                  ...
                  {dataGet.content.split("\n").map((line, index) => {
                    ...
                    if (line.startsWith("\t")) {
                      return (
                        <div
                          key={index}
                          className=" text-lg font-bold tracking-wide text-[#0ccee8]"
                        >
                          <p className="pt-5"></p>
                          {line.substring(1)}
                          <p className="pb-5"></p>
              ...
              <section className="text-white mt-16 md:mx-8">
                ...
                <div className="flex flex-col gap-4 h-auto mt-16 items-center justify-center">
                  {dataGet.definition.map((word) => (
                    ...
                    >
                      <div
                        className={`w-[90%] grid grid-cols-12 border border-[#7a0cf0] rounded-lg p-3 gap-2 items-center  transition delay-150 duration-300 ease-in-out hover:scale-105 transform ${fonts.font_bree} text-lg `}
                      >
                        ...
                        <div className="col-span-11 xl:-ml-5">
                          <p className="text-[[#0ccee8] font-semibold">
                            {word.name}
                          </p>
                        </div>
            ...
            {dataGet.reflect && (
              <section className="mt-20 md:mx-8">
                <div
                  className={`bg-white/[.15] rounded md:p-8 p-5 border-l-8 border-[#7a0cf0] h-auto text-white text-base text-justify ${fonts.font_bree}`}
                  data-aos="fade-up"
                >
